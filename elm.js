...
var author$project$Biome$Cave = {$: 'Cave'};
var author$project$Biome$Desert = {$: 'Desert'};
var author$project$Biome$Forest = {$: 'Forest'};
var author$project$Biome$Frozen = {$: 'Frozen'};
var author$project$Biome$None = {$: 'None'};
var author$project$Biome$Plains = {$: 'Plains'};
var author$project$Biome$fromString = function (b) {
	switch (b) {
		case 'Forest':
			return author$project$Biome$Forest;
		case 'Frozen':
			return author$project$Biome$Frozen;
		case 'Desert':
			return author$project$Biome$Desert;
		case 'Plains':
			return author$project$Biome$Plains;
		case 'Cave':
			return author$project$Biome$Cave;
		default:
			return author$project$Biome$None;
	}
};
var author$project$Model$Easy = {$: 'Easy'};
var author$project$Model$Hard = {$: 'Hard'};
var author$project$Model$Normal = {$: 'Normal'};
var author$project$Model$decodeDifficulty = function (string) {
	switch (string) {
		case 'easy':
			return author$project$Model$Easy;
		case 'normal':
			return author$project$Model$Normal;
		default:
			return author$project$Model$Hard;
	}
};
...
var author$project$Model$initial = {
	biome: author$project$Biome$fromString('Forest'),
	colorSet: {foilage: _List_Nil, ground: _List_Nil, wall: _List_Nil},
	currentMap: '',
	currentRoom: '',
...
var author$project$Model$decode = A8(
	...
	F7(
		function (posX, posY, state, difficulty, biome, mapSeed, roomSeed) {
			return _Utils_update(
				author$project$Model$initial,
				{
					...
					position: _Utils_Tuple2(posX, posY),
					state: state
				});
		}),
	A2(elm$json$Json$Decode$field, 'posX', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'posY', elm$json$Json$Decode$int),
	A2(
	...
	A2(
		elm$json$Json$Decode$field,
		'difficulty',
		A2(elm$json$Json$Decode$map, author$project$Model$decodeDifficulty, elm$json$Json$Decode$string)),
	A2(
		elm$json$Json$Decode$field,
		'biome',
		A2(elm$json$Json$Decode$map, author$project$Biome$fromString, elm$json$Json$Decode$string)),
	A2(elm$json$Json$Decode$field, 'currentMap', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'currentRoom', elm$json$Json$Decode$string));
var author$project$Messages$KeyMsg = function (a) {
	return {$: 'KeyMsg', a: a};
};
...
var author$project$Tiier$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				elm$browser$Browser$Events$onResize(author$project$Messages$Resize),
				A2(elm$core$Platform$Sub$map, author$project$Messages$KeyMsg, ohanhi$keyboard$Keyboard$subscriptions)
			]));
};
var author$project$Biome$getColorRanges = function (b) {
	switch (b.$) {
		case 'Forest':
			return {
				foilage: _List_fromArray(
					[
						_Utils_Tuple2(30, 45),
						_Utils_Tuple2(190, 205),
						_Utils_Tuple2(60, 75)
					]),
				ground: _List_fromArray(
					[
						_Utils_Tuple2(120, 130),
						_Utils_Tuple2(90, 105),
						_Utils_Tuple2(60, 75)
					]),
				wall: _List_fromArray(
					[
						_Utils_Tuple2(199, 235),
						_Utils_Tuple2(199, 235),
						_Utils_Tuple2(199, 235)
					])
			};
		case 'Frozen':
			return {
				foilage: _List_fromArray(
					[
						_Utils_Tuple2(180, 190),
						_Utils_Tuple2(200, 215),
						_Utils_Tuple2(245, 255)
					]),
				ground: _List_fromArray(
					[
						_Utils_Tuple2(245, 255),
		...
		case 'Desert':
			return {
				foilage: _List_fromArray(
					[
						_Utils_Tuple2(200, 210),
						_Utils_Tuple2(160, 170),
						_Utils_Tuple2(16, 40)
					]),
				ground: _List_fromArray(
					[
						_Utils_Tuple2(250, 255),
						_Utils_Tuple2(240, 245),
						_Utils_Tuple2(190, 210)
					]),
				wall: _List_fromArray(
					[
						_Utils_Tuple2(241, 250),
						_Utils_Tuple2(225, 250),
						_Utils_Tuple2(175, 250)
					])
			};
		case 'Plains':
			return {
				foilage: _List_fromArray(
					[
						...
						_Utils_Tuple2(220, 240),
						_Utils_Tuple2(35, 45)
					]),
				ground: _List_fromArray(
					[
						_Utils_Tuple2(50, 60),
						_Utils_Tuple2(150, 160),
						_Utils_Tuple2(35, 40)
					]),
				wall: _List_fromArray(
					[
						_Utils_Tuple2(180, 205),
						_Utils_Tuple2(240, 255),
						_Utils_Tuple2(165, 200)
					])
			};
		case 'Cave':
			return {
				...
				ground: _List_fromArray(
					[
						_Utils_Tuple2(210, 240),
						_Utils_Tuple2(195, 210),
						_Utils_Tuple2(235, 240)
					]),
				wall: _List_fromArray(
					[
						_Utils_Tuple2(199, 235),
		...
		default:
			return {foilage: _List_Nil, ground: _List_Nil, wall: _List_Nil};
	}
};
var author$project$Biome$toString = function (b) {
	switch (b.$) {
		case 'Forest':
			return 'Forest';
		case 'Frozen':
...
var author$project$Model$encodeDifficulty = function (diff) {
	switch (diff.$) {
		case 'Easy':
			return 'easy';
		case 'Normal':
			...
			elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'posX',
						elm$json$Json$Encode$int(model.position.a)),
						_Utils_Tuple2(
						'posY',
						elm$json$Json$Encode$int(model.position.b)),
						_Utils_Tuple2(
						'state',
						...
						'difficulty',
						elm$json$Json$Encode$string(
							author$project$Model$encodeDifficulty(model.difficulty))),
						_Utils_Tuple2(
						'currentMap',
						elm$json$Json$Encode$string(model.currentMap)),
						_Utils_Tuple2(
						'currentRoom',
						elm$json$Json$Encode$string(model.currentRoom)),
						_Utils_Tuple2(
						'biome',
						elm$json$Json$Encode$string(
							author$project$Biome$toString(model.biome)))
					])));
	});
			...
			case 'SetBiome':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							biome: b,
							colorSet: author$project$Biome$getColorRanges(b)
						}),
					elm$core$Platform$Cmd$none);
			case 'KeyMsg':
				var key = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pressedKeys: A2(ohanhi$keyboard$Keyboard$update, key, model.pressedKeys)
						}),
					elm$core$Platform$Cmd$none);
			default:
...
var author$project$Cell$Cell = function (a) {
	return {$: 'Cell', a: a};
};
var author$project$Cell$create = function (rec) {
	return author$project$Cell$Cell(rec);
};
	...
	function (width, height) {
		...
		var data = A2(
			...
			function (_n0) {
				var x = _n0.a;
				var y = _n0.b;
				return author$project$Cell$create(
					{
						_char: '.',
...
var author$project$Grid$toList = function (_n0) {
	var data = _n0.a.data;
	return data;
};
var author$project$Cell$toRecord = function (_n0) {
	var _char = _n0.a._char;
	var color = _n0.a.color;
	var passable = _n0.a.passable;
	var pos = _n0.a.pos;
	return {_char: _char, color: color, passable: passable, pos: pos};
};
...
var author$project$View$cellToAttrs = function (c) {
	var cec = author$project$Cell$toRecord(c);
	return _List_fromArray(
		[
			A2(
			elm$html$Html$Attributes$attribute,
			'x',
			elm$core$String$fromInt(cec.pos.a)),
			A2(
			elm$html$Html$Attributes$attribute,
			'y',
			elm$core$String$fromInt(cec.pos.b))
		]);
};
...
var author$project$View$viewCells = function (cells) {
	return A2(
		elm$core$List$map,
		function (c) {
			return A2(
				...
				elm$core$List$concat(
					_List_fromArray(
						[
							_List_fromArray(
							[
								elm$html$Html$Attributes$class('grid__cell')
							]),
							author$project$View$cellToAttrs(c)
						])),
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$Cell$toRecord(c)._char)
					]));
		},
		cells);
};
...
var author$project$View$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('tiier')
			]),
		_List_fromArray(
			[
				A2(
				...
				author$project$View$viewCells(
					author$project$Grid$toList(
						A2(author$project$Grid$initialize, 50, 40))))
			]));
};
...
var author$project$Tiier$main = elm$browser$Browser$element(
	{
		init: function (value) {
			return _Utils_Tuple2(
				A2(
		...
		subscriptions: author$project$Tiier$subscriptions,
		update: author$project$Update$update,
		view: author$project$View$view
	});
_Platform_export({'Tiier':{'init':author$project$Tiier$main(elm$json$Json$Decode$value)(0)}});}(this));